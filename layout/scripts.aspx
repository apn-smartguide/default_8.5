...
<script src='<%= cacheBreak("/resources/js/jquery.mask.min.js") %>'></script>
<!-- Date widget support -->
...
<!-- Inputmask support -->
<script src='<%= cacheBreak("/resources/js/inputmask.min.js") %>'></script>
<script src='<%= cacheBreak("/resources/js/inputmask.extensions.min.js") %>'></script>
<script src='<%= cacheBreak("/resources/js/inputmask.numeric.extensions.min.js") %>'></script>
<script src='<%= cacheBreak("/resources/js/jquery.inputmask.min.js") %>'></script>
<%-- if you want to use your own copy, of the dataTables.net files and extensions add them here --%>
<!-- datatable.net -->
<%-- <script src='<%= cacheBreak("/resources/plugins/dataTables/Select-1.3.1/js/dataTables.select.js") %>'></script> --%>
<%-- <script src='<%= cacheBreak("/resources/plugins/dataTables/js/jquery.dataTables.min.js") %>'></script> --%>
<%-- <script src='<%= cacheBreak("/resources/plugins/dataTables/js/dataTables.bootstrap.js") %>'></script> --%>
<!-- Custom -->
...
<%-- use custom control javascript.aspx via data property of a statictext field to inject javascript from designer. --%>
<script>
