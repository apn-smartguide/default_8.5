					...
					<apn:choosecontrol runat="server">
						<apn:whencontrol runat="server" type="optgroup">
							...
							<apn:forEach id="control3" runat="server">
								...
								<label id='lbl_<apn:controlattribute runat="server" attr="id"/>_<%=Context.Items["optionIndex"]%>_<%=Context.Items["index"]%>' for='<apn:controlattribute runat="server" attr="id" />_<%=Context.Items["optionIndex"]%>_<%=Context.Items["index"]%>' title='<%=GetAttribute(control3.Current, "title", true)%>'>
						...
						<apn:otherwise runat="server">
							...
							<label id='lbl_<apn:controlattribute runat="server" attr="id"/>_<%=Context.Items["optionIndex"]%>_<%=Context.Items["index"]%>' for='<apn:controlattribute runat="server" attr="id" />_<%=Context.Items["optionIndex"]%>_<%=Context.Items["index"]%>' title='<%=GetAttribute(control2.Current, "title", true)%>'>
							<% ExecutePath("/controls/custom/control-label.aspx"); %>
							</label>
							<% } %>
							<% if (control.Current.getCSSClass().Contains("inline")) { %>
