...
<apn:control runat="server" id="control">
	...
	<apn:ifcontrolrequired runat="server"><span class="required" data-toggle='tooltip' data-html='true' title='<apn:localize runat="server" key="theme.text.required"/>'>*</span></apn:ifcontrolrequired>
