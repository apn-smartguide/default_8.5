...
<apn:control runat="server" id="control">
	...
	<apn:ifnothelplink runat="server"><button type='submit' name='<apn:helpid runat="server"/>' value='<apn:helpid runat="server"/>' class='btn btn-link' title='<apn:localize runat="server" key="theme.text.helptitle"/>'><span class='<apn:localize runat="server" key="theme.icon.help"/>' aria-hidden='true'></span> <apn:localize runat="server" key="theme.text.helplink"/></button></apn:ifnothelplink>
	<% } %>
	--%>
	<% if (!control.Current.getHelp().Equals("")) { %>
		...
		<% } else { %>
			<a href='#'' class='link-help' title='<apn:localize runat="server" key="theme.text.helptitle"/>' data-toggle='modal' data-target='#div_<apn:helpid runat="server"/>' onclick='return false;'><span class='<apn:localize runat="server" key="theme.icon.help"/>' aria-hidden='true'></span> <apn:localize runat="server" key="theme.text.helplink"/></a>
			<!-- Modal -->
				...
				<div class='modal-dialog'>
					<div class='modal-content'>
						<div class='modal-header'>
							<a href='#' class='close' data-dismiss='modal' onclick='return false;'><span aria-hidden='true'>x</span><span class='sr-only'>Close</span></a>
