									...
									<apn:forEach runat="server" id="trRowCol">
										<apn:forEach runat="server" id="trRowField">
											<apn:ChooseControl runat="server">
												...
												<apn:WhenControl type="HIDDEN" runat="server"><td class="display:none"><% if(GetMetaDataValue(control.Current, "unsafe").Equals("true")) { %><apn:value runat="server"/><% } %></td></apn:WhenControl>
												<apn:Otherwise runat="server">
