		...
		<apn:forEach runat="server">
			<apn:forEach runat="server">
				<apn:forEach runat="server" id="headingControl">
					<% if ((headingControl.Current.getCSSClass().Contains("panel-heading-button") || headingControl.Current.getCSSClass().Contains("panel-heading-control")) && !IsPdf && !IsSummary) { ProxyRender = true; Execute("/controls/control.aspx"); ProxyRender = false; } %>
				</apn:forEach>
			</apn:forEach>
		</apn:forEach>
