...
%>
	<div id="div_<apn:name runat='server'/>" class='form-group <apn:cssclass runat="server"/>' 
		...
		>
		<img src="<apn:controlattribute attr='src' runat='server'/>" 
                        id="<apn:code runat='server'/>" 
                        class='<apn:cssclass runat="server"/>'
                        style="width:<apn:controlattribute attr='width' runat='server'/>;height:<apn:controlattribute attr='height' runat='server'/>;<apn:cssstyle runat='server'/>" 
