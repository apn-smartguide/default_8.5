...
<div class="modal-content">
	<div class="modal-header">
		<apn:control runat="server" type="cancel_add_instance">
			<button type="button" 
					class="close repeat_cancel_add_btn" 
	...
	<div class="modal-body" id="div_<%=Context.Items["repeat-name-" + Context.Items["repeat-level"]]%>_add_modal_body">
	...
	<div class="modal-footer">
		<apn:control runat="server" type="save_add_instance">
			<button type="button" 
					class="btn btn-primary repeat_save_add_btn"
                    data-level='<%=Context.Items["repeat-level"]%>'
					data-eventtarget='[<%=Context.Items["repeat-event-targets-add-" + Context.Items["repeat-level"]]%>]' 
					name="<apn:name runat='server'/>" id="<apn:name runat='server'/>"	><apn:localize runat="server" key="theme.modal.add"/></button>
		</apn:control>
		<apn:control runat="server" type="cancel_add_instance">
			<button type="button" 
					class="btn btn-default repeat_cancel_add_btn" 
                    data-level='<%=Context.Items["repeat-level"]%>'
					data-dismiss="modal" 
